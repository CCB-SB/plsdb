...
def get_arg_parser():
    ...
    parser.add_argument('--out-md', help="Output metadata file", required=True)
    parser.add_argument('--out-fasta', help="Output fasta file", required=True)
    parser.add_argument('--log', '-l', help="Logger file", required=True)
    parser.add_argument('--cores', type= int, help="Cores", required=False)
    return parser
